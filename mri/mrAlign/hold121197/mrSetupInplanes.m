function [obX,obY,obXM,obYM,lp,ipThickness,ipSkip] =...
    mrSetupInplanes(numofanats,obXM,obYM,lp,volume_pix_size,inplane_pix_size,curInplane)
...
%          07.28.97 ABP -- On fresh startup, shortened the length of them, added a little twist.
