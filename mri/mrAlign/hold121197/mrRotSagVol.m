...
% update cTheta, aTheta, and curSag. If an
% oblique slice has already been cut, then the oblique image will also be 
% updated with c fcn ObliqueRot such that it remains orthogonal to the
% rotated sagittal plane and intersects at the selected inplane line. Also
% preserves reflection settings. Updates image if show != 0.
