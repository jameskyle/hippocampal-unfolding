function imgStruct = ...
    mrChangeImage(volStruct, displayStruct, grayStruct, layer1Struct, selectedNode, displayData, cutNodes, mVoxelsStruct, h_fig2)
% 
% imgStruct = ...
%   mrChangeImage(volStruct, displayStruct, grayStruct, layer1Struct, selectedNode, displayData, cutNodes, mVoxelsStruct, h_fig2)
% 
...
elseif displayStruct.flags(3) == 1		% showCut flag
  if ~isempty(layer1Struct.nodes)
    mrOverlayLayer1DistScript;
  else
    mrOverlayAllGrayDistScript;
  end
  
elseif displayStruct.flags(5) == 1		% showData flag
