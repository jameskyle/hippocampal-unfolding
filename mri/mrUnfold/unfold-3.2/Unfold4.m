...
% vis = 1;
% saveFlag = 1;
function [gLocs2d,gLocs3d] = Unfold(pFile, vis, saveFlag)

if nargin < 3,  saveFlag = 0; end
if nargin < 2 , vis = 1;      end
...
% cmd = sprintf('cp %s.m %s/paramsFile.m',pFile,saveDir)
% unix(cmd)
...
% end
 ...
 [sampLocsF err] = unfoldFlatten(mDist, sampLocsF, ...
     flatWeight, rSamp,P, sampSpacing, saveDir, nIter, penalty, M, rSeed);
...
% axis equal, axis square, hold off
 ...
 outData = [outData,' startPoint saveDir dimdist'];
