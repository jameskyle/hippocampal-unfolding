function [selectedNode,imgStruct] = mrVolSelect(volStruct,displayStruct,nodes,h_fig2)
% 
%       [selectedNode,imgStruct] = mrVolSelect(volStruct,displayStruct,nodes,h_fig2)
% 
% AUTHOR: Wandell
% DATE:   03.10.97
% PURPOSE:
