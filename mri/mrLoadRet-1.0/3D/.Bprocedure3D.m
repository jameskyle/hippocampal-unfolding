...
% This is not working!!!
% Find red points in layer 1
layer1 = find(nodes(6,unfList) == 1);
layerOfRedPts = nodes(6,redPts);
idx = find(layerOfRedPts == 1);
[junk1, junk2, layer1redPts] = intersect(redPts(idx),layer1);

figure(2)
plot3(xyz_RGBA_test(:,1),xyz_RGBA_test(:,2),xyz_RGBA_test(:,3),'b.')
hold on
plot3(xyz_RGBA_test(layer1redPts,1),xyz_RGBA_test(layer1redPts,2),xyz_RGBA_test(layer1redPts,3),'rx')
