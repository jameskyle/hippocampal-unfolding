function w = makeWedgeWindow(angFunc,nx,ny,nt,shiftStep,direction)
%
%	w = makeWedgeWindow(angFunc,nx,ny,nt,shiftStep,direction)
%
...
for i=1:nt
 ...
 imagesc(reshape(w(:,i),nx,ny)), axis image
 currentAngFunc = vecRotate(currentAngFunc,shiftStep,direction); 
 pause
end
