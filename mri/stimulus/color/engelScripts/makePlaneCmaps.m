...
%
%
cd /usr/local/matlab/toolbox/stanford/color/data
...
lmixes = [0 1 1 -1 1/2 1];		% Generate mixture directions
mmixes = [1 0 1 1 1 1/2];
smixes = [0 0 0 0 0 0] ;
...
save /home/heidi/matlab/color/LMplaneCmap cmap
