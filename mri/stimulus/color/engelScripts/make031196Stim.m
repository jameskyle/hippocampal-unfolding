...
%load /usr/local/matlab/toolbox/stanford/color/data/sanyoLCD/082695/sanyoLCDGam082695
%load /usr/local/matlab/toolbox/stanford/color/data/sanyoLCD/082895/sanyoLCD82895
...
lmixes = [0 1 .5];		% Generate mixture directions
mmixes = [1 0 .5];
smixes = [0 0 0] ;
...
%save /home/engel/mac/color/cmap031196 cmap
