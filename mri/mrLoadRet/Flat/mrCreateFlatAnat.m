...
for brainSide = side
  ...
  unfdir = [voldir,'/',subject,'/',hemisphere,'/unfold/', unfoldSubDir,'/']
  ...
  saveFiles = 'anat anatmap fSize curCrop gray2inplane ';
  saveFiles = [saveFiles, 'gray2flat gLocs3d unfdir comment rowF colF'];
  cmd = sprintf('save Fanat_%s %s',hemisphere,saveFiles)
  eval(cmd)
