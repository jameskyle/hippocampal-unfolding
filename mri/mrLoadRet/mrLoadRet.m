...
% 07.14.98      GMB     Fixed new graph window bug.
...
tFilter=[11,.1];		 % Size and s.d. of temporal filter (see EditTFilter.m)
...
% 
%this command is broken: replaced with new callBackcmd on 7/14/98 by gmb
%callBackcmd = ...
% sprintf('%sgraphWin=figure(%sWindowStyle%s,%smodal%s);figure(loadRetWin)%s',...
%   qt,qt,qt,qt,qt,qt);

callBackcmd = ...
 sprintf('graphWin=figure(%sWindowStyle%s,%smodal%s);figure(loadRetWin)',...
   qt,qt,qt,qt);
