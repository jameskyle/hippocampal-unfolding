function [out1,out2,out3] = mrGinput(arg1,pointerType)
%mrGinput Graphical input from mouse.
%   [X,Y] = GINPUT(N,'pointerType') gets N points from the current axes and returns 
...
%   was used.
%
%   the default pointerType is 'fullcrosshair'

%   Copyright (c) 1984-96 by The MathWorks, Inc.
%   $Revision: 5.18 $  $Date: 1996/11/10 17:48:08 $

%   gmb  3/20/98  gmb added 'pointerType' option

if ~exist('pointerType')
